...
My name is Murage. I am from Kenya and currently living in Canada, where I work on analysing neuroimaging data using python, pandas, numpy & nilearn. 
...
![sql](https://img.shields.io/static/v1?logo=git&label=&message=git&color=111&logoColor=AAA&style=flat-square)
&nbsp;&nbsp;&nbsp;
