...
![spark](https://img.shields.io/static/v1?logo=gnu-make&label=&message=Make&color=111&logoColor=AAA&style=flat-square)
![](https://img.shields.io/static/v1?logo=gnu-bash&label=&message=bash&color=111&logoColor=AAA&style=flat-square)  
<!-- /Shell-Bash-informational?style=flat&logo=gnu-bash&logoColor=white&color=2bbc8a) -->
